...
* **`training_script.py`** — Standalone training script executed on the server.
...
* **`feature_extraction.py`** — DINOv2 extraction script executed on the server to process the massive NGA dataset.
...
##  Shared Data Files (Task 2) **[DATASET LINK](https://github.com/NationalGalleryOfArt/opendata)**
The following NGA Open Data files are required for the Task 2 notebook to run:
